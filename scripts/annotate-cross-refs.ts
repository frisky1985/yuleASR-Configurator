...
const CROSS_REF_MATRIX: Array<
  [
    ...
    string,
    string,
    'equals' | 'less_than' | 'greater_than' | 'in_range' | 'in_enum',
    string,
  ]
> = [
  [
  ...
  [
    ...
    'CanIfTxPduCanId',
    'in_enum',
    'XCP CAN 标识符应匹配 CanIf 配置的 PDU CAN ID',
  ],
  [
    'Com',
    'ComIPduHandleId',
  ...
  [
    ...
    'CanControllerBaudRate',
    'in_range',
    'CanIf 发送 PDU CAN ID 应在 CAN 控制器范围内',
  ],
  [
    'LinIf',
    'LinIfChannelRef',
  ...
  [
    ...
    'CanIfTxPduCanId',
    'in_enum',
    'PduR 路由目标 PDU 应匹配 CanIf 配置',
  ],
  [
    'Gpt',
    'GptChannelTickFrequency',
    'Mcu',
    'McuClockReferenceFrequency',
    'less_than',
    'Gpt 通道时钟频率不应超过 MCU 主时钟参考频率',
  ],
  [
    'Spi',
    'SpiBaudrate',
    ...
    'McuClockReferenceFrequency',
    'less_than',
    'SPI 波特率不应超过 MCU 主时钟参考频率',
  ],
  [
    'Adc',
    'AdcPowerUpDelayValue',
    'Mcu',
    'McuClockReferenceFrequency',
    'less_than',
    'ADC 上电延迟值不应超过 MCU 主时钟参考频率',
  ],
];
