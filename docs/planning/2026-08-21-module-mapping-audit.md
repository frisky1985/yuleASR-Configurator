...
> 审计日期：2026-08-21 01:10 | 审计人：小明（自动脚本 + 人工核验）
> 数据源：Configurator schema 117 文件（103 核心模块去变体）/ yuleASR src/bsw 全层 + middleware/autosar/soad/platform
...
- `codegen.ts` MODULE_IDS 仅 13 个 MCAL（Mcu/Port/Dio/Can/Adc/Icu/Gpt/Pwm/Wdg/Lin/Spi/Fr/Eth）
- codegen switch 支持 ~25 模块：can canif cantrcv comm crc cryif crypto csm dio dlt doip ecum flash fls linker linslave lintrcv mqtt ostimingprotection ramsafety someip someipsd spi swc wdgm
