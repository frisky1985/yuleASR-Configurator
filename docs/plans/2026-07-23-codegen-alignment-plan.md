...
> **发起:** 2026-07-23 10:02 老板指令 **触发:** 12:00 自动开始 **目标:**
> 统一 4 个代码生成器的模板结构、AUTOSAR
> 4.4 合规深度、错误处理、MemMap 集成、文件命名规范
...
1. **文件命名规范** — 统一为 `<Module>_Cfg.h` (B SW 标准) vs 现有混杂
   `Ecuc_<M>.h`, `Os_Types.h` 等
...
6. **Doxygen 注释风格**
   — 统一到 autosar-format.ts 的 generateAutosarFileHeader/FunctionHeader
...
| 6.3 | 更新 docs/TASK_STATUS.md & sprint 文档           | 0.5h | 文档更新      |
