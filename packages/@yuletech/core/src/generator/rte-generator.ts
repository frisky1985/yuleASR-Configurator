...
/*==================[macro definitions]=====================================*/
/** @brief RTE Vendor ID */
#define RTE_VENDOR_ID          ((uint16)0x1234)

/** @brief RTE Module ID */
#define RTE_MODULE_ID          ((uint16)0x0016)

/** @brief RTE Instance ID */
#define RTE_INSTANCE_ID        ((uint8)0)

/* Version Information */
#define RTE_SW_MAJOR_VERSION   ((uint8)1)
#define RTE_SW_MINOR_VERSION   ((uint8)0)
#define RTE_SW_PATCH_VERSION   ((uint8)0)
