...
- Name: config-tree.spec.ts >> Configuration Tree / Module Navigation >> should render the dashboard with configuration list area
- Location: e2e/config-tree.spec.ts:4:3
...
Locator: locator('text=/Recent Configurations|Create your first|No configurations/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Recent Configurations|Create your first|No configurations/i')
