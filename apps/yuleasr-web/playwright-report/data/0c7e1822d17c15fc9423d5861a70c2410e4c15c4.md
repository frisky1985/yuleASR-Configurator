...
- Name: config-tree.spec.ts >> Configuration Tree / Module Navigation >> should display Quick Actions panel
- Location: e2e/config-tree.spec.ts:11:3
...
Locator: locator('text=/Quick Actions/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Quick Actions/i')
