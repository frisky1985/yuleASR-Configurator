...
test.describe('Templates Page', () => {
  ...
  test('should display the Back to Dashboard link', async ({ page }) => {
    ...
    const dashboardLink = page
      .locator('a[href*="dashboard"], a')
      .filter({ hasText: /仪表盘|Dashboard/i })
      .first();
  ...
  test('should display template recommended badges', async ({ page }) => {
    ...
    const badges = page
      .locator('[class*="badge"], [class*="tag"], span')
      .filter({ hasText: /推荐|Recommended|official|官方/i });
