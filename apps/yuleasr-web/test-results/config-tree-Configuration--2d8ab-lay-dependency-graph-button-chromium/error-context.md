...
- Name: config-tree.spec.ts >> Configuration Tree / Module Navigation >> should display dependency graph button
- Location: e2e/config-tree.spec.ts:26:3
...
Locator: getByRole('button', { name: /Dependency Graph/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Dependency Graph/i })
