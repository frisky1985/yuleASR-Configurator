...
- Name: config-tree.spec.ts >> Configuration Tree / Module Navigation >> should display Module Wizard button
- Location: e2e/config-tree.spec.ts:33:3
...
Locator: getByRole('button', { name: /Module Wizard/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Module Wizard/i })
