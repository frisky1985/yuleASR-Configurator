...
export function BulkOperationsPanel({
  ...
  const allSelected =
    filteredModules.length > 0 && filteredModules.every(m => selectedModules.has(m.id));
  ...
  const getLayerColor = (layer: string) => {
    ...
    return (
      colors[layer] ||
      'bg-app-bg-tertiary text-gray-800 dark:bg-app-bg-tertiary dark:text-app-text-tertiary'
    );
  };
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={cn('px-1.5 py-0.5 rounded text-xs', getLayerColor(module.layer))}
                      >
                        {module.layer}
                      </span>
                    </div>
