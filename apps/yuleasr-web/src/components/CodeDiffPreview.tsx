      ...
      <div className="bg-app-bg-primary rounded-xl shadow-xl w-full max-w-5xl mx-4 max-h-[90vh] flex flex-col">
            ...
            <table className="w-full border-collapse font-mono text-xs leading-relaxed">
              <thead>
                <tr className="bg-app-bg-secondary sticky top-0 z-10">
                  <th className="w-12 text-right px-2 py-1 text-app-text-tertiary border-r border-app-border-primary">旧</th>
                ...
                {diffLines.map((line, i) => (
                  ...
                  >
                    <td className={cn(
                      ...
                      line.op === 'delete' ? 'text-red-500 bg-red-50/50' : 'text-app-text-tertiary',
                    ...
                    <td className={cn(
                      ...
                      line.op === 'insert' ? 'text-green-600 bg-green-50/50' : 'text-app-text-tertiary',
        ...
        <div className="flex items-center justify-between px-6 py-3 border-t border-app-border-primary shrink-0 bg-app-bg-secondary">
          <div className="flex items-center gap-3 text-xs text-app-text-tertiary">
            ...
            <span className="inline-flex items-center gap-1">
              <span className="w-3 h-3 rounded bg-app-bg-primary border border-app-border-primary" /> 未变更
            </span>
          </div>
          <button
            onClick={onClose}
