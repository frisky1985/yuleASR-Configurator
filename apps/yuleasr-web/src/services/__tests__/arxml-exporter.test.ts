...
describe('ARXML Exporter', () => {
  ...
  it('should handle 37 modules without error', () => {
    const names =
      'Can,Mcu,Port,Adc,Dio,Gpt,Spi,EcuM,Det,Dem,CanIf,Fee,Fls,BswM,CanTp,Com,Crc,Icu,Dcm,CanNm,CanSM,CanTrcv,PduR,MemIf,Rte,Crypto,Csm,CryIf,Nm,Mcl,IOHWAb,Sbc,Ble,Arti'.split(
        ','
      );
