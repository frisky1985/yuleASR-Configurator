    ...
    containers: [
      {
        ...
        subContainers: [
          { id: "generic_cortex", name: "Generic_CortexM33_Mp", displayName: "Cortex-M33 Derivatives", shortName: "OsDerivativeInformation",
            parameters: [
              { id: "os_mpu_accessible", name: "OsMpuEndAddressAccessible", type: "boolean", value: true },
              { id: "os_mpu_priv_cfg", name: "OsMpuPrivilegedRegionsConfigurable", type: "boolean", value: true },
              { id: "os_stack_align", name: "OsStackAlignment", type: "integer", value: 0 },
              { id: "os_ivt_align", name: "OsInterruptVectorTableAlignment", type: "integer", value: 2048 },
            ],
            subContainers: [
              { id: "os_nvic", name: "NVIC", displayName: "NVIC", shortName: "OsSystemIntCtrl",
                parameters: [
                  { id: "os_nvic_maxprios", name: "OsSystemIntCtrlMaxPrios", type: "integer", value: 256 },
                  { id: "os_nvic_maxsrc", name: "OsSystemIntCtrlMaxSources", type: "integer", value: 496 },
                  { id: "os_nvic_type", name: "OsSystemIntCtrlType", type: "string", value: "NVIC" },
                ] },
              { id: "os_core0", name: "Core0", displayName: "Core0", shortName: "OsPhysicalCore",
                parameters: [
                  { id: "os_core0_id", name: "OsPhysicalCoreId", type: "integer", value: 0 },
                  { id: "os_core0_type", name: "OsPhysicalCoreType", type: "string", value: "Cortex-M33" },
                  { id: "os_core0_entry", name: "OsPhysicalCoreDefaultEntrySymbol", type: "string", value: "_start" },
                ] },
              { id: "os_systick", name: "SysTick", displayName: "SysTick", shortName: "OsHardwareTimer",
                parameters: [
                  { id: "os_systick_id", name: "OsHardwareTimerId", type: "integer", value: 0 },
                  { id: "os_systick_size", name: "OsHardwareTimerSize", type: "integer", value: 24 },
                  { id: "os_systick_type", name: "OsHardwareTimerType", type: "string", value: "SysTick" },
                ] },
            ],
          },
        ],
      },
      {
        ...
        subContainers: [
          { id: "os_stacksummary", name: "OsStackSummary", displayName: "OsStackSummary", shortName: "OsStackSummary",
            parameters: [
              { id: "os_core0_kernel_stack", name: "OsCore0_Kernel_StackSize", type: "integer", value: 1024 },
              { id: "os_core0_init_stack", name: "OsCore0_Init_StackSize", type: "integer", value: 1024 },
              { id: "os_core0_error_stack", name: "OsCore0_Error_StackSize", type: "integer", value: 1024 },
            ] },
          { id: "os_hooks", name: "OsHooks", displayName: "OsHooks", shortName: "OsHooks",
            parameters: [
      ...
      },
      {
        ...
        subContainers: [
          { id: "oscore0_stacks", name: "OsCoreStacks", displayName: "OsCoreStacks", shortName: "OsCoreStacks",
            parameters: [
              { id: "oscore0_kernstack", name: "OsCoreKernelStackSize", type: "integer", value: 1024 },
              { id: "oscore0_startupstack", name: "OsCoreStartupStackSize", type: "integer", value: 1024 },
              { id: "oscore0_errorstack", name: "OsCoreErrorStackSize", type: "integer", value: 1024 },
            ] },
        ],
      },
      {
        ...
        parameters: [
          { id: "oscounter_maxval", name: "OsCounterMaxAllowedValue", type: "integer", value: 2147483647 },
