/**
 * Auto-generated from JSON Schemas - All 39 BSW Modules
 * Generated: 2025-05-21 (YAC-MAP-002 2026-08-21: −ble/mcl/sbc +ethtsyn/ldcom/tm/dds/microdds)
...
export const allModules: ConfigModule[] = [
  ...
  },
  {
    ...
    description: 'DDS 中间件（最小 schema：使能/传输类型/IP 端口；完整配置走代码直连，非 AUTOSAR 标准 BSW）',
    vendor: 'YuleTech',
    version: '4.4.0',
    autosarVersion: '4.4.0',
    layer: 'Service',
    enabled: false,
    parameters: [
      { id: 'dds_enable', name: 'DDS_ENABLE', displayName: 'DDS_ENABLE', description: 'DDS 中间件使能开关', type: 'boolean', value: false, defaultValue: false },
      { id: 'dds_default_domain_id', name: 'DDS_DEFAULT_DOMAIN_ID', displayName: 'DDS_DEFAULT_DOMAIN_ID', description: '默认域 ID（dds_runtime.h）', type: 'integer', value: 0, defaultValue: 0, min: 0, max: 4294967295 },
      { id: 'dds_transport_type', name: 'DDS_TRANSPORT_TYPE', displayName: 'DDS_TRANSPORT_TYPE', description: '传输类型：ETH 多播 RTPS / SOAD SOME-IP 桥接 / TSN', type: 'enum', value: 'DDS_TRANSPORT_ETH', defaultValue: 'DDS_TRANSPORT_ETH', options: [{ value: 'DDS_TRANSPORT_ETH', label: 'ETH RTPS' }, { value: 'DDS_TRANSPORT_SOAD', label: 'SOME-IP 桥接' }, { value: 'DDS_TRANSPORT_TSN', label: 'TSN' }] },
      { id: 'dds_eth_multicast_port_base', name: 'DDS_ETH_MULTICAST_PORT_BASE', displayName: 'DDS_ETH_MULTICAST_PORT_BASE', description: 'RTPS 多播端口基址（dds_eth_transport.h）', type: 'integer', value: 7400, defaultValue: 7400, min: 0, max: 65535 },
      { id: 'dds_eth_tx_buffer_size', name: 'DDS_ETH_TX_BUFFER_SIZE', displayName: 'DDS_ETH_TX_BUFFER_SIZE', description: '传输层发送缓冲', type: 'integer', value: 4096, defaultValue: 4096, min: 0, max: 65535 },
      { id: 'dds_eth_rx_buffer_size', name: 'DDS_ETH_RX_BUFFER_SIZE', displayName: 'DDS_ETH_RX_BUFFER_SIZE', description: '传输层接收缓冲', type: 'integer', value: 8192, defaultValue: 8192, min: 0, max: 65535 },
      { id: 'dds_eth_max_endpoints', name: 'DDS_ETH_MAX_ENDPOINTS', displayName: 'DDS_ETH_MAX_ENDPOINTS', description: '端点上限', type: 'integer', value: 32, defaultValue: 32, min: 0, max: 255 },
      { id: 'dds_eth_max_participants', name: 'DDS_ETH_MAX_PARTICIPANTS', displayName: 'DDS_ETH_MAX_PARTICIPANTS', description: '参与者上限', type: 'integer', value: 16, defaultValue: 16, min: 0, max: 255 },
      { id: 'dds_eth_max_udp_payload', name: 'DDS_ETH_MAX_UDP_PAYLOAD', displayName: 'DDS_ETH_MAX_UDP_PAYLOAD', description: 'UDP 最大负载', type: 'integer', value: 65507, defaultValue: 65507, min: 0, max: 65535 },
      { id: 'dds_soad_adapter_enable', name: 'DDS_SOAD_ADAPTER_ENABLE', displayName: 'DDS_SOAD_ADAPTER_ENABLE', description: 'SOME-IP 桥接使能（dds_soad_adapter）', type: 'boolean', value: false, defaultValue: false },
    ],
    containers: [
      {
        id: 'commonpublishedinformation', name: 'CommonPublishedInformation', displayName: 'CommonPublishedInformation', description: 'CommonPublishedInformation 配置容器', parameters: [
          { id: 'arreleasemajorversion', name: 'ArReleaseMajorVersion', displayName: 'ArReleaseMajorVersion', type: 'integer', value: 4, defaultValue: 4 },
          { id: 'arreleaseminorversion', name: 'ArReleaseMinorVersion', displayName: 'ArReleaseMinorVersion', type: 'integer', value: 3, defaultValue: 3 },
          { id: 'arreleaserevisionversion', name: 'ArReleaseRevisionVersion', displayName: 'ArReleaseRevisionVersion', type: 'integer', value: 0, defaultValue: 0 },
          { id: 'moduleid', name: 'ModuleId', displayName: 'ModuleId', type: 'integer', value: 0, defaultValue: 0 },
          { id: 'swmajorversion', name: 'SwMajorVersion', displayName: 'SwMajorVersion', type: 'integer', value: 1, defaultValue: 1 },
          { id: 'swminorversion', name: 'SwMinorVersion', displayName: 'SwMinorVersion', type: 'integer', value: 0, defaultValue: 0 },
          { id: 'swpatchversion', name: 'SwPatchVersion', displayName: 'SwPatchVersion', type: 'integer', value: 0, defaultValue: 0 },
          { id: 'vendorid', name: 'VendorId', displayName: 'VendorId', type: 'integer', value: 0, defaultValue: 0 },
        ],
        multiple: false,
      },
    ],
  ...
  },
  {
    id: 'ethtsyn',
    name: 'EthTSyn',
    displayName: 'Ethernet Time Synchronization',
    description: '以太网时间同步（EthTSyn，AUTOSAR R21-11 §12.9 gPTP/IEEE 802.1AS；yuleASR services/ethtsyn）',
    vendor: 'YuleTech',
    version: '4.4.0',
    autosarVersion: '4.4.0',
    layer: 'Service',
    enabled: false,
    parameters: [
      { id: 'ethtsyn_dev_error_detect', name: 'ETHTSYN_DEV_ERROR_DETECT', displayName: 'ETHTSYN_DEV_ERROR_DETECT', description: '开发错误检测（EthTSyn.c 内嵌宏）', type: 'boolean', value: true, defaultValue: true },
      { id: 'ethtsyn_version_info_api', name: 'ETHTSYN_VERSION_INFO_API', displayName: 'ETHTSYN_VERSION_INFO_API', description: '版本信息 API（EthTSyn.h 守卫宏）', type: 'boolean', value: true, defaultValue: true },
      { id: 'ethtsyn_main_function_period_ms', name: 'ETHTSYN_MAIN_FUNCTION_PERIOD_MS', displayName: 'ETHTSYN_MAIN_FUNCTION_PERIOD_MS', description: '主函数周期', type: 'integer', value: 10, defaultValue: 10, min: 0, max: 65535 },
    ],
    containers: [
      {
        id: 'commonpublishedinformation', name: 'CommonPublishedInformation', displayName: 'CommonPublishedInformation', description: 'CommonPublishedInformation 配置容器', parameters: [
  ...
  },
  {
    id: 'ldcom',
    name: 'LdCom',
    displayName: 'Large Data Communication',
    description: '大块数据通信（LdCom，AUTOSAR R21-11 §12.11 大 PDU 分段重组；yuleASR services/ldcom）',
    vendor: 'YuleTech',
    version: '4.4.0',
    autosarVersion: '4.4.0',
    layer: 'Service',
    enabled: false,
    parameters: [
      { id: 'ldcom_dev_error_detect', name: 'LDCOM_DEV_ERROR_DETECT', displayName: 'LDCOM_DEV_ERROR_DETECT', description: '开发错误检测（LdCom.c 内嵌宏）', type: 'boolean', value: true, defaultValue: true },
      { id: 'ldcom_version_info_api', name: 'LDCOM_VERSION_INFO_API', displayName: 'LDCOM_VERSION_INFO_API', description: '版本信息 API', type: 'boolean', value: true, defaultValue: true },
      { id: 'ldcom_max_segment_size', name: 'LDCOM_MAX_SEGMENT_SIZE', displayName: 'LDCOM_MAX_SEGMENT_SIZE', description: '分段大小上限', type: 'integer', value: 4096, defaultValue: 4096, min: 0, max: 65535 },
      { id: 'ldcom_max_num_pdus', name: 'LDCOM_MAX_NUM_PDUS', displayName: 'LDCOM_MAX_NUM_PDUS', description: '并发分段 PDU 通道上限', type: 'integer', value: 8, defaultValue: 8, min: 0, max: 255 },
    ],
    containers: [
      {
        id: 'commonpublishedinformation', name: 'CommonPublishedInformation', displayName: 'CommonPublishedInformation', description: 'CommonPublishedInformation 配置容器', parameters: [
  ...
  },
  {
    id: 'microdds',
    name: 'MicroDds',
    displayName: 'Micro-DDS Middleware',
    description: 'Micro-DDS 轻量中间件（资源受限 MCU：ROM<50KB/RAM<16KB；最小 schema，完整配置走代码直连）',
    vendor: 'YuleTech',
    version: '4.4.0',
    autosarVersion: '4.4.0',
    layer: 'Service',
    enabled: false,
    parameters: [
      { id: 'microdds_enable', name: 'MICRODDS_ENABLE', displayName: 'MICRODDS_ENABLE', description: 'Micro-DDS 使能开关', type: 'boolean', value: false, defaultValue: false },
      { id: 'microdds_default_domain_id', name: 'MICRODDS_DEFAULT_DOMAIN_ID', displayName: 'MICRODDS_DEFAULT_DOMAIN_ID', description: '默认域 ID', type: 'integer', value: 0, defaultValue: 0, min: 0, max: 4294967295 },
      { id: 'microdds_max_participants', name: 'MICRODDS_MAX_PARTICIPANTS', displayName: 'MICRODDS_MAX_PARTICIPANTS', description: '参与者上限', type: 'integer', value: 4, defaultValue: 4, min: 0, max: 255 },
      { id: 'microdds_max_topics', name: 'MICRODDS_MAX_TOPICS', displayName: 'MICRODDS_MAX_TOPICS', description: '主题上限', type: 'integer', value: 8, defaultValue: 8, min: 0, max: 255 },
      { id: 'microdds_max_publishers', name: 'MICRODDS_MAX_PUBLISHERS', displayName: 'MICRODDS_MAX_PUBLISHERS', description: '发布者上限', type: 'integer', value: 8, defaultValue: 8, min: 0, max: 255 },
      { id: 'microdds_max_subscribers', name: 'MICRODDS_MAX_SUBSCRIBERS', displayName: 'MICRODDS_MAX_SUBSCRIBERS', description: '订阅者上限', type: 'integer', value: 8, defaultValue: 8, min: 0, max: 255 },
      { id: 'microdds_max_data_writers', name: 'MICRODDS_MAX_DATA_WRITERS', displayName: 'MICRODDS_MAX_DATA_WRITERS', description: '数据写入器上限', type: 'integer', value: 16, defaultValue: 16, min: 0, max: 255 },
      { id: 'microdds_max_data_readers', name: 'MICRODDS_MAX_DATA_READERS', displayName: 'MICRODDS_MAX_DATA_READERS', description: '数据读取器上限', type: 'integer', value: 16, defaultValue: 16, min: 0, max: 255 },
      { id: 'microdds_max_instances', name: 'MICRODDS_MAX_INSTANCES', displayName: 'MICRODDS_MAX_INSTANCES', description: '实例上限', type: 'integer', value: 32, defaultValue: 32, min: 0, max: 255 },
      { id: 'microdds_topic_name_max', name: 'MICRODDS_TOPIC_NAME_MAX', displayName: 'MICRODDS_TOPIC_NAME_MAX', description: '主题名最大长度', type: 'integer', value: 64, defaultValue: 64, min: 0, max: 255 },
    ],
    containers: [
      {
        id: 'commonpublishedinformation', name: 'CommonPublishedInformation', displayName: 'CommonPublishedInformation', description: 'CommonPublishedInformation 配置容器', parameters: [
  ...
  },
  {
    ...
    description: '时间管理（Tm，AUTOSAR R21-11 §12.15 时间基同步/换算/定时事件调度；yuleASR services/tm）',
    vendor: 'YuleTech',
    version: '4.4.0',
    autosarVersion: '4.4.0',
    layer: 'Service',
    enabled: false,
    parameters: [
      { id: 'tm_dev_error_detect', name: 'TM_DEV_ERROR_DETECT', displayName: 'TM_DEV_ERROR_DETECT', description: '开发错误检测（Tm.c 内嵌宏）', type: 'boolean', value: true, defaultValue: true },
      { id: 'tm_version_info_api', name: 'TM_VERSION_INFO_API', displayName: 'TM_VERSION_INFO_API', description: '版本信息 API', type: 'boolean', value: true, defaultValue: true },
      { id: 'tm_num_time_bases', name: 'TM_NUM_TIME_BASES', displayName: 'TM_NUM_TIME_BASES', description: '时间基数量上限', type: 'integer', value: 4, defaultValue: 4, min: 0, max: 255 },
      { id: 'tm_default_resolution', name: 'TM_DEFAULT_RESOLUTION', displayName: 'TM_DEFAULT_RESOLUTION', description: '默认时间基分辨率', type: 'integer', value: 1000, defaultValue: 1000, min: 0, max: 4294967295 },
      { id: 'tm_enable_sync', name: 'TM_ENABLE_SYNC', displayName: 'TM_ENABLE_SYNC', description: '使能时间基同步', type: 'boolean', value: false, defaultValue: false },
      { id: 'tm_main_function_period_ms', name: 'TM_MAIN_FUNCTION_PERIOD_MS', displayName: 'TM_MAIN_FUNCTION_PERIOD_MS', description: '主函数周期', type: 'integer', value: 10, defaultValue: 10, min: 0, max: 65535 },
    ],
    containers: [
      {
        id: 'commonpublishedinformation', name: 'CommonPublishedInformation', displayName: 'CommonPublishedInformation', description: 'CommonPublishedInformation 配置容器', parameters: [
