...
const IMX8M_PINS: Pin[] = [
  ...
  // GPIO1 组
  {
    ...
    number: 5,
    name: 'GPIO1_IO00',
    functions: ['GPIO', 'UART1_TX', 'CAN1_TX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    id: 'GPIO1_1',
    number: 6,
    name: 'GPIO1_IO01',
    functions: ['GPIO', 'UART1_RX', 'CAN1_RX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  ...
  },
  {
    ...
    number: 9,
    name: 'GPIO1_IO04',
    functions: ['GPIO', 'I2C1_SCL', 'SPI1_CS'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 10,
    name: 'GPIO1_IO05',
    functions: ['GPIO', 'I2C1_SDA', 'SPI1_SCK'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 11,
    name: 'GPIO1_IO06',
    functions: ['GPIO', 'SPI1_MOSI', 'UART3_TX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 12,
    name: 'GPIO1_IO07',
    functions: ['GPIO', 'SPI1_MISO', 'UART3_RX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  ...
  },
  {
    ...
    number: 17,
    name: 'GPIO2_IO04',
    functions: ['GPIO', 'SPI2_CS', 'UART4_TX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 18,
    name: 'GPIO2_IO05',
    functions: ['GPIO', 'SPI2_SCK', 'UART4_RX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 19,
    name: 'GPIO2_IO06',
    functions: ['GPIO', 'SPI2_MOSI', 'CAN1_TX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  {
    ...
    number: 20,
    name: 'GPIO2_IO07',
    functions: ['GPIO', 'SPI2_MISO', 'CAN1_RX'],
    defaultFunction: 'GPIO',
    currentFunction: 'GPIO',
    isConfigurable: true,
  },
  ...
  // USB
  {
    ...
    name: 'USB_DP',
    functions: ['USB_DP'],
    defaultFunction: 'USB_DP',
    currentFunction: 'USB_DP',
    isConfigurable: false,
  },
  {
    id: 'USB_1',
    ...
    name: 'USB_DM',
    functions: ['USB_DM'],
    defaultFunction: 'USB_DM',
    currentFunction: 'USB_DM',
    isConfigurable: false,
  },
  {
    id: 'USB_2',
...
const functionColors: Record<PinFunction, string> = {
  ...
  CAN_TX: 'bg-green-500',
  CAN_RX: 'bg-green-600',
  CAN1_TX: 'bg-green-500',
  CAN1_RX: 'bg-green-600',
  CAN2_TX: 'bg-green-500',
  CAN2_RX: 'bg-green-600',
  SPI_MOSI: 'bg-purple-500',
  SPI_MISO: 'bg-purple-600',
  SPI_SCK: 'bg-purple-700',
  SPI_CS: 'bg-purple-400',
  SPI1_MOSI: 'bg-purple-500',
  SPI1_MISO: 'bg-purple-600',
  SPI1_SCK: 'bg-purple-700',
  SPI1_CS: 'bg-purple-400',
  SPI2_MOSI: 'bg-purple-500',
  SPI2_MISO: 'bg-purple-600',
  SPI2_SCK: 'bg-purple-700',
  SPI2_CS: 'bg-purple-400',
  UART_TX: 'bg-orange-500',
  UART_RX: 'bg-orange-600',
  UART_RTS: 'bg-orange-400',
  UART_CTS: 'bg-orange-700',
  UART1_TX: 'bg-orange-500',
  UART1_RX: 'bg-orange-600',
  UART2_TX: 'bg-orange-500',
  UART2_RX: 'bg-orange-600',
  UART3_TX: 'bg-orange-500',
  UART3_RX: 'bg-orange-600',
  UART4_TX: 'bg-orange-500',
  UART4_RX: 'bg-orange-600',
  I2C_SDA: 'bg-cyan-500',
  I2C_SCL: 'bg-cyan-600',
  I2C1_SDA: 'bg-cyan-500',
  I2C1_SCL: 'bg-cyan-600',
  I2C2_SDA: 'bg-cyan-500',
  I2C2_SCL: 'bg-cyan-600',
  PWM: 'bg-pink-500',
  PWM1: 'bg-pink-500',
  PWM2: 'bg-pink-600',
  PWM3: 'bg-pink-500',
...
export function PinConfigurator() {
  ...
  const filteredPins = useMemo(() => {
    ...
    return pins.filter(
      pin => pin.functions.includes(activeFilter) || pin.currentFunction === activeFilter
    );
  }, [pins, activeFilter]);
  ...
  const updatePinFunction = (pinId: string, newFunction: PinFunction) => {
    setPins(prev =>
      prev.map(pin => (pin.id === pinId ? { ...pin, currentFunction: newFunction } : pin))
    );
  };
        ...
        <div className="flex-1 p-6 bg-muted/5 overflow-auto">
          ...
          <div className="grid grid-cols-4 gap-2">
            {filteredPins.map(pin => {
              ...
              const isActive =
                activeFilter !== 'ALL' &&
                (pin.functions.includes(activeFilter) || pin.currentFunction === activeFilter);
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span
                      className={`w-2 h-2 rounded-full ${functionColors[pin.currentFunction]}`}
                    />
          ...
          <div className="mt-6 p-3 bg-muted/30 rounded-lg">
            ...
            <div className="flex flex-wrap gap-2">
              {Object.entries(functionColors)
                .filter(
                  ([func]) => !['RESET', 'POWER', 'GND', 'NC', 'USB_DP', 'USB_DM'].includes(func)
                )
                .map(([func, color]) => (
                  <div key={func} className="flex items-center gap-1">
                    <span className={`w-2 h-2 rounded-full ${color}`} />
                    <span className="text-[10px] text-muted-foreground">
                      {functionLabels[func as PinFunction]}
                    </span>
                  </div>
                ))}
            </div>
