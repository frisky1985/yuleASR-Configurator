...
export const REGISTRY_MODULES: RegistryModule[] = [
  {
    ...
    layer: 'MCAL',
    description:
      '完整的 CAN/CANFD/TCAN 协议栈实现，支持经典 CAN 2.0 和 CAN FD 灵活数据速率。包含 Can_Init、Can_Write、Can_Read 等标准 API，支持 DLC 校验、错误处理及 Bus-Off 恢复。',
  ...
  },
  {
    ...
    layer: 'MCAL',
    description:
      '通用数字 I/O 驱动，兼容标准 AutoSAR DIO 规范。支持 Dio_ReadChannel、Dio_WriteChannel、Dio_ReadPort、Dio_WritePort，以及通道组批量读写和电平翻转功能。',
  ...
  },
  {
    ...
    layer: 'MCAL',
    description:
      '高性能 SPI 主从驱动，支持同步/异步模式、DMA 传输、多片选管理。兼容标准 AutoSAR SPI Handler/Driver 规范，支持队列化传输和中断控制。',
              ...
              SpiChannels: [
                {
                  id: 'SpiChannel_0',
                  spiChannelId: 0,
                  spiChannelType: 'HALF_DUPLEX',
                  spiDataWidth: 8,
                },
                {
                  id: 'SpiChannel_1',
                  spiChannelId: 1,
                  spiChannelType: 'FULL_DUPLEX',
                  spiDataWidth: 16,
                },
              ],
              SibNtfConfig: [{ id: 'SibNtf_0', spiNotificationType: 'TX_COMPLETE' }],
            },
          },
        },
      },
  ...
  },
  {
    ...
    layer: 'MCAL',
    description:
      'MCU 时钟和复位管理模块，支持 PLL 频率配置、时钟树设置、看门狗管理、低功耗模式切换。自动适配不同 MCU 的时钟树拓扑。',
  ...
  },
  {
    ...
    layer: 'Service',
    description:
      '完整 OSEK/VDX 标准调度器实现，支持优先级调度、时间触发的 TASK、ISR 中断服务管理、资源管理、事件机制、ALARM 定时器和计数服务。',
  ...
  },
  {
    ...
    layer: 'ECUAL',
    description:
      'LIN 2.2 协议栈实现，支持主从模式、帧调度表、诊断传输层。兼容标准 LIN 规范，支持自动波特率检测和帧超时监控。',
              ...
              LinSchedules: [
                {
                  ...
                  linScheduleEntries: [
                    {
                      linFrameId: 0,
                      linFrameResponseType: 'SLAVE_RESPONSE',
                      linFrameDlc: 8,
                      linEntryDelay: 10,
                    },
                    {
                      linFrameId: 1,
                      linFrameResponseType: 'MASTER_RESPONSE',
                      linFrameDlc: 6,
                      linEntryDelay: 10,
                    },
                  ],
  ...
  },
  {
    ...
    layer: 'Complex',
    description:
      '以太网 Socket 适配器模块，支持 TCP/UDP Socket 管理、多连接、PduR 路由。当前为预览版，支持基础 TCP 连接和数据收发。',
  ...
  },
  {
    ...
    layer: 'Service',
    description:
      '看门狗驱动和管理模块，支持硬件和软件看门狗。Wdg 提供底层触发/刷新，WdgM 提供多级监控、触发条件和故障恢复策略。',
    ...
    dependencies: [{ name: 'MCU Driver', version: '>=1.0.0', optional: false }],
  ...
  },
  {
    ...
    layer: 'MCAL',
    description:
      'PWM 输出和输入捕获驱动模块。Pwm 支持多通道 PWM 输出、频率/占空比调制、边缘对齐和中心对齐模式。Icu 支持输入捕获、信号测量和周期检测。',
  ...
  },
  {
    ...
    layer: 'Service',
    description:
      'Flash 驱动和 NVRAM 管理器。Fls 提供 Flash 读写擦除操作，NvM 提供 EEPROM 模拟、数据管理和校验。当前为 Beta 版，支持基本块操作。',
              ...
              FlsSectors: [
                {
                  id: 'FlsSector_0',
                  flsSectorIndex: 0,
                  flsSectorStartAddr: 0,
                  flsSectorSize: 32768,
                },
                {
                  id: 'FlsSector_1',
                  flsSectorIndex: 1,
                  flsSectorStartAddr: 32768,
                  flsSectorSize: 32768,
                },
              ],
            },
