...
export function canUserAccessModule(
  ...
  return (
    module.permissions.read.includes(userId) ||
...
export function getPlanLimits(plan: string) {
  const limits: Record<
    string,
    { maxMembers: number; maxPrivateModules: number; maxTeams: number }
  > = {
