...
export const articles: BlogArticle[] = [
  {
    ...
    description:
      '深入解析 AutoSAR 基础软件 (BSW) 的分层架构设计原理，包括 MCAL、ECUAL、Service 层的职责划分与交互机制。',
...
`,
  ...
  },
  {
    ...
    description:
      '详细介绍 CAN 通信协议原理，以及如何在 AutoSAR 中配置 Communication (Com) 模块实现数据发送与接收。',
...
`,
  ...
  },
  {
    ...
    description:
      '基于 NXP S32K3 系列芯片的 MCAL 配置实战，包括 ADC、PWM、GPIO 等模块的详细配置步骤。',
...
`,
  ...
  },
  {
    ...
    description:
      '使用 Jenkins、Docker 和静态代码分析工具构建完整的汽车软件持续集成/持续部署流水线。',
...
`,
  ...
  },
  {
    ...
    description:
      '深入探讨 AutoSAR NVM (Non-Volatile Memory) 模块的数据管理机制，包括数据块配置、写入策略和损耗均衡算法。',
